    ...
    return (
        <div className="space-y-4 sm:space-y-6 h-full flex flex-col">
            ...
            <Sheet open={!!selectedClientId} onOpenChange={(open) => !open && setSelectedClientId(null)}>
                <SheetContent
                    side="right"
                    className="w-[400px] sm:w-[540px] md:w-[700px] p-0 border-l border-gray-200 dark:border-gray-800 transition-transform duration-300 ease-in-out data-[shifted=true]:!-translate-x-full"
                    {...{ "data-shifted": !!selectedProjectId }}
                >
            ...
            {/* Project Details Sheet (Stacked) */}
            <Sheet open={!!selectedProjectId} onOpenChange={(open) => !open && setSelectedProjectId(null)}>
                <SheetContent
                    side="right"
                    hideOverlay
                    className="w-[400px] sm:w-[540px] md:w-[700px] p-0 border-l border-gray-200 dark:border-gray-800 sm:max-w-[700px] shadow-2xl"
                >
